...
empty_mem_output_buffer(j_compress_ptr cinfo)
{
  ...
  nextbuffer = (JOCTET *)tkl_system_sram_malloc(nextsize);
  ...
  tkl_system_sram_free(dest->newbuffer);
              ...
              unsigned long *outsize)
{
  ...
  if (*outbuffer == NULL || *outsize == 0) {
    ...
    dest->newbuffer = *outbuffer = (unsigned char *)tkl_system_sram_malloc(OUTPUT_BUF_SIZE);
