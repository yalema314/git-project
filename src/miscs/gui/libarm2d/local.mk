...
LOCAL_TUYA_SDK_CFLAGS += $(addprefix -I ,$(shell find $(LOCAL_PATH)/src -type d))
...
LOCAL_CFLAGS += $(addprefix -I ,$(shell find $(LOCAL_PATH)/src -type d))
...
#endif # CONFIG_TUYA_LVGL_DRAW_WITH_ARM2D
#---------------------------------------
