 ...
 */
#ifndef STACK_SIZE_LVGL_DRAW
#define LV_DRAW_THREAD_STACK_SIZE    (8 * 1024)             /**< [bytes]*/
#else
#define LV_DRAW_THREAD_STACK_SIZE    STACK_SIZE_LVGL_DRAW   /*[bytes]*/
#endif
...
#ifndef TASK_PRIORITY_LVGL_DRAW
#define LV_DRAW_THREAD_PRIO LV_THREAD_PRIO_HIGHEST
#else
#define LV_DRAW_THREAD_PRIO TASK_PRIORITY_LVGL_DRAW
#endif
...
#define LV_USE_DRAW_SW 1
    ...
    #if defined(TUYA_LVGL_DRAW_WITH_ARM2D) && (TUYA_LVGL_DRAW_WITH_ARM2D == 1)
    ...
    #define LV_DRAW_SW_COMPLEX          1
        ...
        #define  LV_DRAW_SW_ASM_CUSTOM_INCLUDE "arm2d/lv_draw_sw_arm2d.h"
        #define  LV_DRAW_SW_ASM_CUSTOM_BLEND_INCLUDE "arm2d/lv_blend_arm2d.h"
    #endif
...
#if LV_USE_FS_FATFS
    #define LV_FS_FATFS_LETTER '/'     /**< Set an upper-case driver-identifier letter for this driver (e.g. 'A'). */
