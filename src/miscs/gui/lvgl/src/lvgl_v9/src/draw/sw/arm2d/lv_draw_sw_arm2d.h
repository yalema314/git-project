                                        ...
                                        const lv_draw_image_dsc_t * draw_dsc)
{
    ...
    if (!arm_2d_initialized) {
        LV_LOG_WARN("-------arm_2d init start for sw draw");
    ...
    do {
        ...
        && !(  (LV_COLOR_FORMAT_RGB565 == src_cf)
           ||  (LV_COLOR_FORMAT_RGB565A8 == src_cf))) {
            LV_LOG_WARN("-------err format mismatch[des:0x%x][src:0x%x],sw_arm2d start fail", des_cf, src_cf);
            break;
        }
        ...
        || (LV_COLOR_FORMAT_ARGB8888 == des_cf)) {
            LV_LOG_WARN("-------err unsupport des format [des:0x%x],sw_arm2d start fail", des_cf);
            break;
        }
    #endif
