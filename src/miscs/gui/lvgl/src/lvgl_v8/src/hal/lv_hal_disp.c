...
#if LV_SNAPSHOT_USE_PSRAM
    ty_psram_byte_write(&buf_px[0], res_color.full);
#else
...
#if CONFIG_SOC_BK7256
#if LV_SNAPSHOT_USE_PSRAM
    ty_psram_byte_write(&buf_px[0], res_color.full & 0xff);
    ty_psram_byte_write(&buf_px[1], res_color.full >> 8);
#else
...
#if CONFIG_SOC_BK7256
#if LV_SNAPSHOT_USE_PSRAM
    ty_psram_byte_write(&buf_px[0], res_color.ch.blue);
    ty_psram_byte_write(&buf_px[1], res_color.ch.green);
    ty_psram_byte_write(&buf_px[2], res_color.ch.red);
#else
