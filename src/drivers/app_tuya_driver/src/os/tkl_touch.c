 ...
 *    - others: other errors.
 */
OPERATE_RET tkl_touch_gpio_init(touch_channel_t touch_id)
{
    return bk_touch_gpio_init(touch_id);
}
 ...
 *    - others: other errors.
 */
OPERATE_RET tkl_touch_enable(touch_channel_t touch_id)
{
    return bk_touch_enable(touch_id);
}
 ...
 *    - BK_OK: succeed
 */
OPERATE_RET tkl_touch_disable(void)
{
    return bk_touch_disable();
}
 ...
 */
OPERATE_RET tkl_touch_config(const touch_config_t *touch_config)
{
    return bk_touch_config(touch_config);
}
 ...
 *    - BK_OK: succeed
 */
OPERATE_RET tkl_touch_calibration_start(void)
{
    return bk_touch_calibration_start();
}
 ...
 *    - BK_OK: succeed
 */
OPERATE_RET tkl_touch_scan_mode_enable(uint32_t enable)
{
    return bk_touch_scan_mode_enable(enable);
}
 ...
 *    - BK_OK: succeed
 */
OPERATE_RET tkl_touch_adc_mode_enable(uint32_t enable)
{
    return bk_touch_adc_mode_enable(enable);
}
 ...
 *    - BK_OK: succeed
 */
OPERATE_RET tkl_touch_manul_mode_enable(uint32_t calib_value)
{
    return bk_touch_manul_mode_enable(calib_value);
}
 ...
 *    - BK_OK: succeed
 */
OPERATE_RET tkl_touch_manul_mode_disable(void)
{
    return bk_touch_manul_mode_disable();
}
 ...
 *    - BK_OK: succeed
 */
OPERATE_RET tkl_touch_scan_mode_multi_channl_set(touch_channel_t touch_id)
{
    return bk_touch_scan_mode_multi_channl_set(touch_id);
}
 ...
 *    - BK_OK: succeed
 */
OPERATE_RET tkl_touch_int_enable(touch_channel_t touch_id, uint32_t enable)
{
    return bk_touch_int_enable(touch_id, enable);
}
 ...
 */
UINT32_T tkl_touch_get_calib_value(void)
{
    return bk_touch_get_calib_value();
}
 ...
 */
UINT32_T tkl_touch_get_touch_status(void)
{
    return bk_touch_get_touch_status();
}
 ...
 *    - BK_OK: succeed
 */
OPERATE_RET tkl_touch_digital_tube_init(void)
{
    return bk_touch_digital_tube_init();
}
 ...
 *    - None
 */
VOID tkl_touch_digital_tube_display(uint8_t disp_value)
{
    bk_touch_digital_tube_display(disp_value);
}
 ...
 *    - None
 */
VOID tkl_touch_wakeup_channel_set(touch_channel_t channel)
{
    bk_touch_wakeup_channel_set(channel);
}
 ...
 */
UINT32_T tkl_touch_wakeup_channel_get(void)
{
    return bk_touch_wakeup_channel_get();
}
 ...
 *    - others: other errors.
 */
OPERATE_RET tkl_touch_pm_init(void)
{
    return bk_touch_pm_init();
}
 ...
 *    - others: other errors.
 */
OPERATE_RET tkl_touch_register_touch_isr(touch_channel_t touch_id, touch_isr_t isr, void *param)
{
    return bk_touch_register_touch_isr(touch_id, isr, param);
}